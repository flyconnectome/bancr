# Getting help with bancr

Thanks for using bancr. We're sorry if you're having trouble, but don't worry,
...
* Search GitHub for [_issues_ with the bancr package](https://github.com/natverse/banc/issues).
...
* If you need to report a *new* bug:
  please [file an issue](https://github.com/natverse/banc/issues/new).
* If you're not sure:
